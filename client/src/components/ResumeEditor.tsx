...
const ResumeEditor: React.FC<ResumeEditorProps> = ({ resumeData, onResumeChange, previewHtml, sections }) => {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                onChange={(e) => handleFieldChange('linkedIn', e.target.value, 'personalInfo')} 
                                className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                            />
                        </div>
                        <div>
                            ...
                            <input 
                                ...
                                onChange={(e) => handleFieldChange('github', e.target.value, 'personalInfo')} 
                                className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                            />
                        </div>
                    </div>
            ...
            {activeTab === 'skills' && (
                <div className="space-y-4">
                    <div>
                        ...
                        />
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            Separate skills with commas. Focus on relevant technical and soft skills.
                        </p>
                    </div>
            ...
            {activeTab === 'experience' && (
                <div className="space-y-6">
                    {resumeData.experience.map((exp, index) => (
                        <div key={exp.id} className="p-6 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            value={exp.position} 
                                            onChange={(e) => handleFieldChange('position', e.target.value, 'experience', index)} 
                                            className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            value={exp.company} 
                                            onChange={(e) => handleFieldChange('company', e.target.value, 'experience', index)} 
                                            className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input 
                                            type="month" 
                                            value={exp.startDate} 
                                            onChange={(e) => handleFieldChange('startDate', e.target.value, 'experience', index)} 
                                            className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input 
                                            type="month" 
                                            value={exp.endDate} 
                                            onChange={(e) => handleFieldChange('endDate', e.target.value, 'experience', index)} 
                                            className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                                        />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea 
                                        ...
                                        onChange={(e) => handleFieldChange('description', e.target.value, 'experience', index)} 
                                        rows={4} 
                                        className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors resize-none" 
                                    />
                                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
             ...
             {activeTab === 'education' && (
                <div className="space-y-6">
                    {resumeData.education.map((edu, index) => (
                        <div key={edu.id} className="p-6 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                            <div className="flex justify-between items-start mb-4">
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            onChange={(e) => handleFieldChange('institution', e.target.value, 'education', index)} 
                                            className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            value={edu.degree} 
                                            onChange={(e) => handleFieldChange('degree', e.target.value, 'education', index)} 
                                            className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            onChange={(e) => handleFieldChange('fieldOfStudy', e.target.value, 'education', index)} 
                                            className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input 
                                            type="month" 
                                            value={edu.endDate} 
                                            onChange={(e) => handleFieldChange('endDate', e.target.value, 'education', index)} 
                                            className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                                        />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        placeholder="3.8" 
                                        value={edu.gpa || ''} 
                                        onChange={(e) => handleFieldChange('gpa', e.target.value, 'education', index)} 
                                        className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                                    />
                                </div>
                            </div>
            ...
            {activeTab === 'projects' && (
                <div className="space-y-6">
                    {(resumeData.projects || []).map((project, index) => (
                        <div key={project.id} className="p-6 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                            <div className="flex justify-between items-start mb-4">
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            value={project.name} 
                                            onChange={(e) => handleFieldChange('name', e.target.value, 'projects', index)} 
                                            className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            onChange={(e) => handleFieldChange('technologies', e.target.value.split(',').map(s => s.trim()).filter(s => s), 'projects', index)} 
                                            className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                                        />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea 
                                        ...
                                        onChange={(e) => handleFieldChange('description', e.target.value, 'projects', index)} 
                                        rows={4} 
                                        className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors resize-none" 
                                    />
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            onChange={(e) => handleFieldChange('githubLink', e.target.value, 'projects', index)} 
                                            className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Live Demo (Optional)</label>
                                        <input 
                                            type="text" 
                                            placeholder="example.com" 
                                            value={project.liveLink || ''} 
                                            onChange={(e) => handleFieldChange('liveLink', e.target.value, 'projects', index)} 
                                            className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white transition-colors" 
                                        />
                                    </div>
                                </div>
